"""Download a curated subset of CMU MoCap BVH files for the walk/jump task.

The selection mirrors the one used by the reference repo (Filip Langiewicz)
so that comparisons stay fair, plus a few extra walking trials from
subjects 35/36 to enlarge the training pool.

Source: ``una-dinosauria/cmu-mocap`` (BVH conversion of the CMU Graphics
Lab MoCap database).
"""
